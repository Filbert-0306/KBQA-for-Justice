...
def gen_training_data(raw_data_path):
    label_list = [line.strip() for line in open('../../../../KBQA-for-Diagnosis-main/nlu/bert_intent_recognition/label', 'r', encoding='utf8')]
    print(label_list)
...
def gen_sample_base_template():
    ...
    disease_list = json.load(open(
        '../../../../KBQA-for-Diagnosis-main/knowledge_extraction/bilstm_crf/checkpoint/diseases.json', 'r', encoding='utf8'))
...
if __name__ == '__main__':
    data_path = "../../../../KBQA-for-Diagnosis-main/nlu/bert_intent_recognition/data/CMID/CMID.json"
