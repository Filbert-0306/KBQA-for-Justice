...
class TextConfig():
    ...
    embedding_size=256     #dimension of word embedding，原来100，改改
    vocab_size=1692        #number of vocabulary        # 原来是8000，报错Invalid argument: Assign requires shapes of both tensors to match. lhs shape= [8000,100] rhs shape= [1692,100]
    ...
    train_filename='./data/xsbh10&16_template_train.txt'  #train data
    test_filename='./data/xsbh10&16_template_test.txt'    #test data
    val_filename='./data/xsbh10&16_template_test.txt'      #validation data
    vocab_filename='./data/vocab_2.txt'        #vocabulary
    vector_word_filename='./data/vector_word_2.txt'  #vector_word trained by word2vec
    vector_word_npz='./data/vector_word_2.npz'   # save vector_word to numpy file
